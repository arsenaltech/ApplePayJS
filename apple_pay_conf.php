...
define('PRODUCTION_CERTIFICATE_KEY', './ApplePaypkcs8.key.pem');
...
define('PRODUCTION_DOMAINNAME', 'uat.erincondren.com');
...
define('PRODUCTION_COUNTRYCODE', 'USA');                // https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2
define('PRODUCTION_DISPLAYNAME', 'Erincondren');
